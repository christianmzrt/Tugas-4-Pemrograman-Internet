        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('fakultas.index') }}">
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="px-4 py-3">
                                    <span class="badge bg-success">{{ $f->kode_fakultas }}</span>
                                </td>
                                ...
                                <td class="px-4 py-3 text-center">
                                    <div class="d-flex gap-1 justify-content-center">
                                        ...
                                        <form action="{{ route('fakultas.destroy', $f->id) }}" 
                                              method="POST" 
                                              class="d-inline"
                                              onsubmit="return confirm('Yakin ingin menghapus fakultas {{ $f->nama_fakultas }}?')">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" 
                            ...
                            @empty
                            <tr>
                                <td colspan="{{ Auth::check() && Auth::user()->isAdmin() ? '4' : '3' }}" 
